...
Engine2D::cDynamicCollection* CreateCollectionInstance( const unsigned int Id, const Vector2D& Pos, const int Argument ) {
	...
	switch ( Id ) {
		...
		case 151: {
			return new Engine2D::cDynamicCollection( "2D/ForegroundElementsThree/ForegroundCactusOne.coll", Pos );
			break;
		}
		case 152: {
			return new Engine2D::cDynamicCollection( "2D/ForegroundElementsThree/ForegroundCactusTwo.coll", Pos );
			break;
		}
		case 153: {
		...
		case 156: {
			return new Engine2D::cDynamicCollection( "2D/ForegroundElementsThree/ForegroundCactusSix.coll", Pos );
			break;
		}

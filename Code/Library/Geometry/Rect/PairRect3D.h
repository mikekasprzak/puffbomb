...
public:
	...
	// - -------------------------------------------------------------------------------------- - //
	inline PairRect3D( const Vector3D& _Vec1, const Vector3D& _Vec2 ) :
		_P1( _Vec1 ),
		_P2( _Vec1 + _Vec2 )
	{
	}
	...
	// Pair Creation (P1, P2) //
	// - -------------------------------------------------------------------------------------- - //
	inline PairRect3D( const bool&, const Vector3D& _Vec1, const Vector3D& _Vec2 ) :
	...
	// - -------------------------------------------------------------------------------------- - //
	inline PairRect3D( const bool&, const bool&, const Vector3D& _Vec1, const Vector3D& _Vec2 ) :
		_P1( _Vec1 ),
		_P2( _Vec2 )
	{
	}
	...
	// - -------------------------------------------------------------------------------------- - //
	inline PairRect3D( const bool&, const bool&, const bool&, const Vector3D& _VecCenter, const Vector3D& _VecShape ) :
...
public:
	...
	// Creation as a Pair //
	// - -------------------------------------------------------------------------------------- - //
	inline static const PairRect3D Pair( const Real& _x1, const Real& _y1, const Real& _z1, const Real& _x2, const Real& _y2, const Real& _z2 ) {
		return PairRect3D( true, Vector3D( _x1, _y1, _z1 ), Vector3D( _x2, _y2, _z2 ) );
	}
	// - -------------------------------------------------------------------------------------- - //
	inline static const PairRect3D Pair( const Vector3D& _Vec1, const Vector3D& _Vec2 ) {
		return PairRect3D( true, _Vec1, _Vec2 );
	}
	// - -------------------------------------------------------------------------------------- - //
	// Optimized Pair Creation (both points must be in the correct space, no min/max'ing done) //
	// - -------------------------------------------------------------------------------------- - //
	inline static const PairRect3D _Pair( const Vector3D& _Vec1, const Vector3D& _Vec2 ) {
		return PairRect3D( true, true, _Vec1, _Vec2 );
	}
	// - -------------------------------------------------------------------------------------- - //	
	...
	// - -------------------------------------------------------------------------------------- - //
	inline static const PairRect3D Radius( const Real& _x1, const Real& _y1, const Real& _z1, const Real& _x2, const Real& _y2, const Real& _z2 ) {
		return PairRect3D( true, true, true, Vector3D( _x1, _y1, _z1 ), Vector3D( _x2, _y2, _z2 ) );
	}
	// - -------------------------------------------------------------------------------------- - //
	inline static const PairRect3D Radius( const Vector3D& _Vec1, const Vector3D& _Vec2 ) {
		return PairRect3D( true, true, true, _Vec1, _Vec2 );
	}
	// - -------------------------------------------------------------------------------------- - //
...
public:	
	...
	inline const bool operator == ( const PairRect3D& Vs ) const;
	// - -------------------------------------------------------------------------------------- - //
	inline const bool operator != ( const PairRect3D& Vs ) const {
		return !(*this == Vs);
	}
	...
	inline const PairRect3D operator - ( const PairRect3D& Vs ) const {
		return Pair(
...
public:
	...
	inline const PairRect3D operator + ( const Vector3D& Vs ) const {

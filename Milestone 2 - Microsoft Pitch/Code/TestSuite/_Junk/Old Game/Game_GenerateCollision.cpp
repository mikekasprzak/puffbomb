...
//				StaticObject[idx]->Polygon.push_back( cStaticPolygon( 3 ) );
//				StaticObject[idx]->Polygon.back().Index[0] = __vp[prev];
//				StaticObject[idx]->Polygon.back().Index[1] = __vp[min_vert];
//				StaticObject[idx]->Polygon.back().Index[2] = __vp[next];
//				StaticObject[idx]->Polygon.back().CalcBoundingRect( *StaticObject[idx] );
//		
...
//			StaticObject[idx]->Polygon.push_back( cStaticPolygon( 3 ) );
//			StaticObject[idx]->Polygon.back().Index[0] = __vp[0];
//			StaticObject[idx]->Polygon.back().Index[1] = __vp[1];
//			StaticObject[idx]->Polygon.back().Index[2] = __vp[2];
//			StaticObject[idx]->Polygon.back().CalcBoundingRect( *StaticObject[idx] );
//		}	
//	}
//	
...
//	for( size_t idx = 0; idx < StaticObject.size(); idx++ ) {
//		for ( size_t idx2 = 0; idx2 < StaticObject[idx]->Polygon.size(); idx2++ ) {
//			StaticObject[idx]->Polygon[idx2].CalcBoundingRect( *StaticObject[idx] );
//		}
//		StaticObject[idx]->CalcBoundingRect();
//	}
}
// - ------------------------------------------------------------------------------------------ - //
